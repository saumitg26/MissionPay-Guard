...
import { Upload, CheckCircle, Lock, FileText, ShieldCheck, ArrowRight, AlertCircle } from "lucide-react";
              ...
              >
                <div className="flex items-center gap-3">
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    {uploaded[doc.key] && <p className="text-green-600 text-xs mt-1 font-medium">✓ {doc.label.replace(/\(.*\)/, "").trim()}_FINAL.pdf — Uploaded 14:28</p>}
                  </div>
                  <div className="text-xs text-slate-400 shrink-0">
                    {uploaded[doc.key] ? "" : "Drop file or click"}
                  </div>
                </div>
              </div>
            ))}
