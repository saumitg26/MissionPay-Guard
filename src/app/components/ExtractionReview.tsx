...
import { extractedFields, ACTIVE_CASE } from "../data/mockData";
  ...
  return (
    <div className="flex-1 overflow-hidden flex flex-col bg-slate-50">
      ...
      <div className="shrink-0 bg-white border-b border-slate-200 px-6 py-2.5 flex items-center gap-6 text-xs">
        <span className="text-slate-500">Case: <span className="font-mono font-semibold text-slate-800">{ACTIVE_CASE.caseId}</span></span>
              ...
              <div className="p-4 text-[10px] font-mono text-slate-700 space-y-3 leading-relaxed">
                {activeDoc === "invoice" && (
                  <>
                    <div className="text-center border-b border-slate-200 pb-3">
                      <div className="font-bold text-sm text-slate-900">{ACTIVE_CASE.vendor.toUpperCase()}</div>
                    ...
                    <div className="border-t border-slate-200 pt-3 mt-3">
                      ...
                      <div className="border-t border-slate-200 mt-2 pt-2 flex justify-between font-bold text-slate-900">
                        <span>TOTAL DUE</span><span className="bg-yellow-100 px-0.5">{ACTIVE_CASE.amount}</span>
                      </div>
                    </div>
                ...
                {activeDoc === "po" && (
                  <>
                    ...
                    <div><span className="text-slate-400">VENDOR:</span> {ACTIVE_CASE.vendor}</div>
